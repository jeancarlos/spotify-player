...
export function MediaCard({
  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden rounded-[4px] shadow-lg group-hover:shadow-xl ring-1 ring-white/10 transition-all duration-200 group-hover:scale-105 group-active:scale-95">
        {imageUrl ? (
          <img
            src={imageUrl}
            alt={title}
